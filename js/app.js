(() => {
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        let s = {
            init(e = null) {
                let t;
                e || (e = document.querySelectorAll("._letter-animation"));
                let s = -1;
                for (let i = 0; i < e.length; i++) {
                    let n = e[i], r = n.textContent.replace(/\s+/g, " ").trim().split(" "), a = "", o = .04;
                    for (let e = 0; e < r.length; e++) {
                        let i = r[e], l = i.length;
                        if (l > 0) {
                            if (a.length > 0) a += "&nbsp;</p><p>"; else a += "<p>";
                            for (let e = 0; e < l; e++) {
                                let n = i.substr(e, 1);
                                if (" " === n) n = "&nbsp;";
                                t = o + .04 * e;
                                a += `<span style="transition-delay: ${t}s;">${n}</span>`;
                            }
                            o = t;
                        }
                    }
            ...
            clear(e = null) {
                e || (e = document.querySelectorAll("._letter-animation p"));
                e.forEach((e => {
                    e.style.cssText = "";
                }));
            }
